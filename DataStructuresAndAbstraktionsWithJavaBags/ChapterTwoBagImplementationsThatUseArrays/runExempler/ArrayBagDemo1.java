...
/**
 * A test of the methods add, toArray, and isFull, as defined in the first draft
...
public class ArrayBagDemo1 
{
	...
	{
		String[] herpderp = {"herpderp","herpderp"};
		BagInterface<String> aBag = new ArrayBag<String>(6);
		
		for(int i = 0; i <= 11; i++)
		{
			System.out.println(aBag.add("WOAH"));
		}
